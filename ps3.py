...
def get_word_score(word:str, n:int)->int:
    ...
    first_component = 0
    for letter in word:
        value = SCRABBLE_LETTER_VALUES[letter.lower()]
...
def deal_hand(n):
    ...
    for i in range(num_vowels):
        ...
        hand[x] = hand.get(x, 0) + 1    #[key:value],x is the key and hand[x] is the value
...
#
def update_hand(hand:typing.Dict[str, int], word:str)->typing.Dict[str, int]:
    """
...
#
def is_valid_word(word:str, hand:typing.Dict[str,int], word_list:list):
    """
